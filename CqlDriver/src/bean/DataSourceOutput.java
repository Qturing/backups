...
public class DataSourceOutput implements Serializable{
	 ...
	 */
	public static DataSource getBeanByModel(DataSourceOutput source) throws IllegalAccessException, InvocationTargetException{
	 ...
	 * @throws IllegalAccessException 
	 */
	public static DataSourceOutput getModelByBean(DataSource source) throws IllegalAccessException, InvocationTargetException{
		DataSourceOutput target = new DataSourceOutput();
		BeanUtils.copyProperties(source, target);
		return target;
	}
